...
static PyMethodDef __pyx_mdef_13smlm_analysis_7cluster_14_voronoi_inner_1voronoi_inner = {"voronoi_inner", (PyCFunction)__pyx_pw_13smlm_analysis_7cluster_14_voronoi_inner_1voronoi_inner, METH_VARARGS|METH_KEYWORDS, 0};
...
static int __pyx_pymod_exec__voronoi_inner(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init smlm_analysis.cluster._voronoi_inner", 0, __pyx_lineno, __pyx_filename);
    }
