...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "smlm_analysis.cluster._focal_inner",
        "sources": [
            "smlm_analysis/cluster/_focal_inner.pyx"
        ]
    },
    "module_name": "smlm_analysis.cluster._focal_inner"
}
END: Cython Metadata */
...
#define __PYX_HAVE__smlm_analysis__cluster___focal_inner
#define __PYX_HAVE_API__smlm_analysis__cluster___focal_inner
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'smlm_analysis.cluster._focal_inner' */
...
static PyObject *__pyx_f_13smlm_analysis_7cluster_12_focal_inner__density(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice); /*proto*/
...
#define __Pyx_MODULE_NAME "smlm_analysis.cluster._focal_inner"
extern int __pyx_module_is_main_smlm_analysis__cluster___focal_inner;
int __pyx_module_is_main_smlm_analysis__cluster___focal_inner = 0;

/* Implementation of 'smlm_analysis.cluster._focal_inner' */
...
static const char __pyx_k_core_map[] = "core_map";
...
static const char __pyx_k_density_map[] = "density_map";
...
static const char __pyx_k_density_map_at_minl[] = "density_map_at_minl";
...
static const char __pyx_k_smlm_analysis_cluster__focal_inn[] = "smlm_analysis/cluster/_focal_inner.pyx";
static const char __pyx_k_unable_to_allocate_shape_and_str[] = "unable to allocate shape and strides.";
static const char __pyx_k_Format_string_allocated_too_shor_2[] = "Format string allocated too short.";
static const char __pyx_k_smlm_analysis_cluster__focal_inn_2[] = "smlm_analysis.cluster._focal_inner";
...
static PyObject *__pyx_n_s_core_map;
static PyObject *__pyx_n_s_density;
static PyObject *__pyx_n_s_density_map;
static PyObject *__pyx_n_s_density_map_at_minl;
...
static PyObject *__pyx_kp_s_smlm_analysis_cluster__focal_inn;
static PyObject *__pyx_n_s_smlm_analysis_cluster__focal_inn_2;
...
static PyObject *__pyx_pf_13smlm_analysis_7cluster_12_focal_inner_density_map(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_i_x, __Pyx_memviewslice __pyx_v_i_y, __Pyx_memviewslice __pyx_v_grid, int __pyx_v_minL); /* proto */
static PyObject *__pyx_pf_13smlm_analysis_7cluster_12_focal_inner_2density_map_at_minl(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_i_x, __Pyx_memviewslice __pyx_v_i_y, __Pyx_memviewslice __pyx_v_grid, int __pyx_v_minL); /* proto */
...
/* "smlm_analysis/cluster/_focal_inner.pyx":7
...
static PyObject *__pyx_f_13smlm_analysis_7cluster_12_focal_inner__density(CYTHON_UNUSED __Pyx_memviewslice __pyx_v_i_x, CYTHON_UNUSED __Pyx_memviewslice __pyx_v_i_y, __Pyx_memviewslice __pyx_v_grid) {
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_v_m;
  int __pyx_v_n;
  ...
  __Pyx_RefNannySetupContext("_density", 0);

  /* "smlm_analysis/cluster/_focal_inner.pyx":11
 *     cdef:
 *         int i, j, m, n
 ...
 */
  __pyx_v_xsize = (__pyx_v_grid.shape[1]);

  /* "smlm_analysis/cluster/_focal_inner.pyx":12
 *         int i, j, m, n
 *         int xsize = grid.shape[1]
 *         int ysize = grid.shape[0]             # <<<<<<<<<<<<<<
 *         int[:, ::1] density = np.zeros((ysize, xsize), dtype=np.int32)
 * 
 */
  __pyx_v_ysize = (__pyx_v_grid.shape[0]);

  /* "smlm_analysis/cluster/_focal_inner.pyx":13
 *         int xsize = grid.shape[1]
 *         int ysize = grid.shape[0]
 *         int[:, ::1] density = np.zeros((ysize, xsize), dtype=np.int32)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_ysize); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_xsize); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 13, __pyx_L1_error)
  ...
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_int(__pyx_t_5, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_v_density = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "smlm_analysis/cluster/_focal_inner.pyx":15
 *         int[:, ::1] density = np.zeros((ysize, xsize), dtype=np.int32)
 * 
 *     for i in range(1, ysize - 1):             # <<<<<<<<<<<<<<
 ...
 *             for m in range(-1, 2):
 */
  __pyx_t_7 = (__pyx_v_ysize - 1);
  __pyx_t_8 = __pyx_t_7;
  for (__pyx_t_9 = 1; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
    __pyx_v_i = __pyx_t_9;

    /* "smlm_analysis/cluster/_focal_inner.pyx":16
 * 
 *     for i in range(1, ysize - 1):
 *         for j in range(1, xsize - 1):             # <<<<<<<<<<<<<<
 *             for m in range(-1, 2):
 *                 for n in range(-1, 2):
 */
    __pyx_t_10 = (__pyx_v_xsize - 1);
    __pyx_t_11 = __pyx_t_10;
    for (__pyx_t_12 = 1; __pyx_t_12 < __pyx_t_11; __pyx_t_12+=1) {
      __pyx_v_j = __pyx_t_12;

      /* "smlm_analysis/cluster/_focal_inner.pyx":17
 *     for i in range(1, ysize - 1):
 *         for j in range(1, xsize - 1):
 *             for m in range(-1, 2):             # <<<<<<<<<<<<<<
 *                 for n in range(-1, 2):
 ...
 */
      for (__pyx_t_13 = -1; __pyx_t_13 < 2; __pyx_t_13+=1) {
        ...
        /* "smlm_analysis/cluster/_focal_inner.pyx":18
 *         for j in range(1, xsize - 1):
 *             for m in range(-1, 2):
 *                 for n in range(-1, 2):             # <<<<<<<<<<<<<<
 *                     density[i, j] += grid[i + m, j + n]
 ...
 */
        for (__pyx_t_14 = -1; __pyx_t_14 < 2; __pyx_t_14+=1) {
          ...
          /* "smlm_analysis/cluster/_focal_inner.pyx":19
 *             for m in range(-1, 2):
 *                 for n in range(-1, 2):
 *                     density[i, j] += grid[i + m, j + n]             # <<<<<<<<<<<<<<
 * 
 *     return density
 */
          __pyx_t_15 = (__pyx_v_i + __pyx_v_m);
          __pyx_t_16 = (__pyx_v_j + __pyx_v_n);
          __pyx_t_17 = __pyx_v_i;
          __pyx_t_18 = __pyx_v_j;
          *((int *) ( /* dim=1 */ ((char *) (((int *) ( /* dim=0 */ (__pyx_v_density.data + __pyx_t_17 * __pyx_v_density.strides[0]) )) + __pyx_t_18)) )) += (*((int *) ( /* dim=1 */ ((char *) (((int *) ( /* dim=0 */ (__pyx_v_grid.data + __pyx_t_15 * __pyx_v_grid.strides[0]) )) + __pyx_t_16)) )));
        }
      }
    }
  }

  /* "smlm_analysis/cluster/_focal_inner.pyx":21
 *                     density[i, j] += grid[i + m, j + n]
 * 
 *     return density             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_5 = __pyx_memoryview_fromslice(__pyx_v_density, 2, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_r = __pyx_t_5;
  __pyx_t_5 = 0;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_AddTraceback("smlm_analysis.cluster._focal_inner._density", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* "smlm_analysis/cluster/_focal_inner.pyx":25
 * @cython.boundscheck(False)
 * @cython.wraparound(False)
...
/* Python wrapper */
static PyObject *__pyx_pw_13smlm_analysis_7cluster_12_focal_inner_1density_map(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_13smlm_analysis_7cluster_12_focal_inner_1density_map = {"density_map", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_13smlm_analysis_7cluster_12_focal_inner_1density_map, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_13smlm_analysis_7cluster_12_focal_inner_1density_map(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("density_map (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_i_x,&__pyx_n_s_i_y,&__pyx_n_s_grid,&__pyx_n_s_minL,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_i_y)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("density_map", 1, 4, 4, 1); __PYX_ERR(0, 25, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_grid)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("density_map", 1, 4, 4, 2); __PYX_ERR(0, 25, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_minL)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("density_map", 1, 4, 4, 3); __PYX_ERR(0, 25, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "density_map") < 0)) __PYX_ERR(0, 25, __pyx_L3_error)
      }
    ...
    __pyx_v_i_x = __Pyx_PyObject_to_MemoryviewSlice_dc_int(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_i_x.memview)) __PYX_ERR(0, 25, __pyx_L3_error)
    __pyx_v_i_y = __Pyx_PyObject_to_MemoryviewSlice_dc_int(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_i_y.memview)) __PYX_ERR(0, 25, __pyx_L3_error)
    __pyx_v_grid = __Pyx_PyObject_to_MemoryviewSlice_d_dc_int(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_grid.memview)) __PYX_ERR(0, 25, __pyx_L3_error)
    __pyx_v_minL = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_minL == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 25, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("density_map", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 25, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("smlm_analysis.cluster._focal_inner.density_map", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_13smlm_analysis_7cluster_12_focal_inner_density_map(__pyx_self, __pyx_v_i_x, __pyx_v_i_y, __pyx_v_grid, __pyx_v_minL);
...
static PyObject *__pyx_pf_13smlm_analysis_7cluster_12_focal_inner_density_map(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_i_x, __Pyx_memviewslice __pyx_v_i_y, __Pyx_memviewslice __pyx_v_grid, int __pyx_v_minL) {
  int __pyx_v_i;
  int __pyx_v_xsize;
  int __pyx_v_ysize;
  __Pyx_memviewslice __pyx_v_density = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_core_map = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  Py_ssize_t __pyx_t_17;
  Py_ssize_t __pyx_t_18;
  __Pyx_RefNannySetupContext("density_map", 0);

  /* "smlm_analysis/cluster/_focal_inner.pyx":29
 *     cdef:
 *         int i, j, m, n
 *         int xsize = grid.shape[1]             # <<<<<<<<<<<<<<
 *         int ysize = grid.shape[0]
 ...
 */
  ...
  /* "smlm_analysis/cluster/_focal_inner.pyx":30
 *         int i, j, m, n
 *         int xsize = grid.shape[1]
 *         int ysize = grid.shape[0]             # <<<<<<<<<<<<<<
 *         int[:, ::1] density = np.zeros((ysize, xsize), dtype=np.int32)
 ...
 */
  ...
  /* "smlm_analysis/cluster/_focal_inner.pyx":31
 *         int xsize = grid.shape[1]
 *         int ysize = grid.shape[0]
 *         int[:, ::1] density = np.zeros((ysize, xsize), dtype=np.int32)             # <<<<<<<<<<<<<<
 *         int[:, ::1] core_map = np.zeros((ysize, xsize), dtype=np.int32)
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_ysize); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_xsize); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  ...
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_int(__pyx_t_5, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_v_density = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "smlm_analysis/cluster/_focal_inner.pyx":32
 *         int ysize = grid.shape[0]
 *         int[:, ::1] density = np.zeros((ysize, xsize), dtype=np.int32)
 *         int[:, ::1] core_map = np.zeros((ysize, xsize), dtype=np.int32)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __Pyx_PyInt_From_int(__pyx_v_ysize); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_xsize); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  ...
  __Pyx_GetModuleGlobalName(__pyx_t_5, __pyx_n_s_np); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_int32); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  ...
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_int(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_core_map = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "smlm_analysis/cluster/_focal_inner.pyx":34
 *         int[:, ::1] core_map = np.zeros((ysize, xsize), dtype=np.int32)
 * 
 *     density = _density(i_x, i_y, grid)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_1 = __pyx_f_13smlm_analysis_7cluster_12_focal_inner__density(__pyx_v_i_x, __pyx_v_i_y, __pyx_v_grid); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 34, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_int(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 34, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __PYX_XDEC_MEMVIEW(&__pyx_v_density, 1);
  __pyx_v_density = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  ...
  /* "smlm_analysis/cluster/_focal_inner.pyx":36
 *     density = _density(i_x, i_y, grid)
 * 
 *     for i in range(i_x.shape[0]):             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_t_7 = (__pyx_v_i_x.shape[0]);
  __pyx_t_8 = __pyx_t_7;
  for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
    __pyx_v_i = __pyx_t_9;

    /* "smlm_analysis/cluster/_focal_inner.pyx":37
 * 
 *     for i in range(i_x.shape[0]):
 *         if density[i_y[i], i_x[i]] > minL:             # <<<<<<<<<<<<<<
 *             core_map[i_y[i], i_x[i]] = 1
 ...
 */
    ...
    __pyx_t_12 = (*((int *) ( /* dim=0 */ ((char *) (((int *) __pyx_v_i_y.data) + __pyx_t_10)) )));
    __pyx_t_13 = (*((int *) ( /* dim=0 */ ((char *) (((int *) __pyx_v_i_x.data) + __pyx_t_11)) )));
    __pyx_t_14 = (((*((int *) ( /* dim=1 */ ((char *) (((int *) ( /* dim=0 */ (__pyx_v_density.data + __pyx_t_12 * __pyx_v_density.strides[0]) )) + __pyx_t_13)) ))) > __pyx_v_minL) != 0);
    if (__pyx_t_14) {

      /* "smlm_analysis/cluster/_focal_inner.pyx":38
 *     for i in range(i_x.shape[0]):
 *         if density[i_y[i], i_x[i]] > minL:
 *             core_map[i_y[i], i_x[i]] = 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __pyx_t_17 = (*((int *) ( /* dim=0 */ ((char *) (((int *) __pyx_v_i_y.data) + __pyx_t_15)) )));
      __pyx_t_18 = (*((int *) ( /* dim=0 */ ((char *) (((int *) __pyx_v_i_x.data) + __pyx_t_16)) )));
      *((int *) ( /* dim=1 */ ((char *) (((int *) ( /* dim=0 */ (__pyx_v_core_map.data + __pyx_t_17 * __pyx_v_core_map.strides[0]) )) + __pyx_t_18)) )) = 1;
 ...
 */
  ...
  /* "smlm_analysis/cluster/_focal_inner.pyx":40
 *             core_map[i_y[i], i_x[i]] = 1
 * 
 *     return np.array(core_map)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_v_core_map, 2, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 40, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = NULL;
 ...
 */
  ...
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_density, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_core_map, 1);
...
/* "smlm_analysis/cluster/_focal_inner.pyx":45
 * @cython.boundscheck(False)
 * @cython.wraparound(False)
...
/* Python wrapper */
static PyObject *__pyx_pw_13smlm_analysis_7cluster_12_focal_inner_3density_map_at_minl(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_13smlm_analysis_7cluster_12_focal_inner_3density_map_at_minl = {"density_map_at_minl", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_13smlm_analysis_7cluster_12_focal_inner_3density_map_at_minl, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_13smlm_analysis_7cluster_12_focal_inner_3density_map_at_minl(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_i_x = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_i_y = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_grid = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_minL;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("density_map_at_minl (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_i_x,&__pyx_n_s_i_y,&__pyx_n_s_grid,&__pyx_n_s_minL,0};
    PyObject* values[4] = {0,0,0,0};
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_i_y)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("density_map_at_minl", 1, 4, 4, 1); __PYX_ERR(0, 45, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_grid)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("density_map_at_minl", 1, 4, 4, 2); __PYX_ERR(0, 45, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_minL)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("density_map_at_minl", 1, 4, 4, 3); __PYX_ERR(0, 45, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "density_map_at_minl") < 0)) __PYX_ERR(0, 45, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 4) {
      goto __pyx_L5_argtuple_error;
    } else {
    ...
    __pyx_v_i_x = __Pyx_PyObject_to_MemoryviewSlice_dc_int(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_i_x.memview)) __PYX_ERR(0, 45, __pyx_L3_error)
    __pyx_v_i_y = __Pyx_PyObject_to_MemoryviewSlice_dc_int(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_i_y.memview)) __PYX_ERR(0, 45, __pyx_L3_error)
    __pyx_v_grid = __Pyx_PyObject_to_MemoryviewSlice_d_dc_int(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_grid.memview)) __PYX_ERR(0, 45, __pyx_L3_error)
    __pyx_v_minL = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_minL == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 45, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("density_map_at_minl", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 45, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("smlm_analysis.cluster._focal_inner.density_map_at_minl", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_13smlm_analysis_7cluster_12_focal_inner_2density_map_at_minl(__pyx_self, __pyx_v_i_x, __pyx_v_i_y, __pyx_v_grid, __pyx_v_minL);
...
static PyObject *__pyx_pf_13smlm_analysis_7cluster_12_focal_inner_2density_map_at_minl(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_i_x, __Pyx_memviewslice __pyx_v_i_y, __Pyx_memviewslice __pyx_v_grid, int __pyx_v_minL) {
  int __pyx_v_i;
  int __pyx_v_xsize;
  int __pyx_v_ysize;
  __Pyx_memviewslice __pyx_v_density = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  Py_ssize_t __pyx_t_17;
  Py_ssize_t __pyx_t_18;
  __Pyx_RefNannySetupContext("density_map_at_minl", 0);

  /* "smlm_analysis/cluster/_focal_inner.pyx":49
 *     cdef:
 *         int i, j, m, n
 *         int xsize = grid.shape[1]             # <<<<<<<<<<<<<<
 *         int ysize = grid.shape[0]
 ...
 */
  ...
  /* "smlm_analysis/cluster/_focal_inner.pyx":50
 *         int i, j, m, n
 *         int xsize = grid.shape[1]
 *         int ysize = grid.shape[0]             # <<<<<<<<<<<<<<
 *         int[:, ::1] density = np.zeros((ysize, xsize), dtype=np.int32)
 ...
 */
  ...
  /* "smlm_analysis/cluster/_focal_inner.pyx":51
 *         int xsize = grid.shape[1]
 *         int ysize = grid.shape[0]
 *         int[:, ::1] density = np.zeros((ysize, xsize), dtype=np.int32)             # <<<<<<<<<<<<<<
 *         int[:, ::1] core_map = np.zeros((ysize, xsize), dtype=np.int32)
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_ysize); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 51, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_xsize); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 51, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  ...
  __Pyx_GetModuleGlobalName(__pyx_t_1, __pyx_n_s_np); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 51, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_int32); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 51, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  /* "smlm_analysis/cluster/_focal_inner.pyx":52
 *         int ysize = grid.shape[0]
 *         int[:, ::1] density = np.zeros((ysize, xsize), dtype=np.int32)
 *         int[:, ::1] core_map = np.zeros((ysize, xsize), dtype=np.int32)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __Pyx_PyInt_From_int(__pyx_v_ysize); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 52, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_xsize); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 52, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  ...
  __Pyx_GetModuleGlobalName(__pyx_t_5, __pyx_n_s_np); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 52, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_int32); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 52, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  ...
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_int(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 52, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_core_map = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "smlm_analysis/cluster/_focal_inner.pyx":54
 *         int[:, ::1] core_map = np.zeros((ysize, xsize), dtype=np.int32)
 * 
 *     density = _density(i_x, i_y, grid)             # <<<<<<<<<<<<<<
 * 
 *     for i in range(i_x.shape[0]):
 */
  __pyx_t_1 = __pyx_f_13smlm_analysis_7cluster_12_focal_inner__density(__pyx_v_i_x, __pyx_v_i_y, __pyx_v_grid); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 54, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_int(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 54, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __PYX_XDEC_MEMVIEW(&__pyx_v_density, 1);
  __pyx_v_density = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  ...
  /* "smlm_analysis/cluster/_focal_inner.pyx":56
 *     density = _density(i_x, i_y, grid)
 * 
 *     for i in range(i_x.shape[0]):             # <<<<<<<<<<<<<<
 *         if density[i_y[i], i_x[i]] == minL:
 ...
 */
  ...
  for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
    ...
    /* "smlm_analysis/cluster/_focal_inner.pyx":57
 * 
 *     for i in range(i_x.shape[0]):
 *         if density[i_y[i], i_x[i]] == minL:             # <<<<<<<<<<<<<<
 *             core_map[i_y[i], i_x[i]] = 1
 ...
 */
    ...
    if (__pyx_t_14) {
      ...
      /* "smlm_analysis/cluster/_focal_inner.pyx":58
 *     for i in range(i_x.shape[0]):
 *         if density[i_y[i], i_x[i]] == minL:
 *             core_map[i_y[i], i_x[i]] = 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "smlm_analysis/cluster/_focal_inner.pyx":60
 *             core_map[i_y[i], i_x[i]] = 1
 * 
 *     return np.array(core_map)             # <<<<<<<<<<<<<<
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_v_core_map, 2, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 60, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = NULL;
  if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_3))) {
    __pyx_t_4 = PyMethod_GET_SELF(__pyx_t_3);
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "smlm_analysis.cluster._focal_inner.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "smlm_analysis.cluster._focal_inner.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "smlm_analysis.cluster._focal_inner.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "smlm_analysis.cluster._focal_inner._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec__focal_inner(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec__focal_inner},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_core_map, __pyx_k_core_map, sizeof(__pyx_k_core_map), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_density_map_at_minl, __pyx_k_density_map_at_minl, sizeof(__pyx_k_density_map_at_minl), 0, 0, 1, 1},
  ...
  {&__pyx_kp_s_smlm_analysis_cluster__focal_inn, __pyx_k_smlm_analysis_cluster__focal_inn, sizeof(__pyx_k_smlm_analysis_cluster__focal_inn), 0, 0, 1, 0},
  {&__pyx_n_s_smlm_analysis_cluster__focal_inn_2, __pyx_k_smlm_analysis_cluster__focal_inn_2, sizeof(__pyx_k_smlm_analysis_cluster__focal_inn_2), 0, 0, 1, 1},
 ...
 *     cdef:
 */
  __pyx_tuple__26 = PyTuple_Pack(12, __pyx_n_s_i_x, __pyx_n_s_i_y, __pyx_n_s_grid, __pyx_n_s_minL, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_m, __pyx_n_s_n, __pyx_n_s_xsize, __pyx_n_s_ysize, __pyx_n_s_density, __pyx_n_s_core_map); if (unlikely(!__pyx_tuple__26)) __PYX_ERR(0, 25, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__26);
  __Pyx_GIVEREF(__pyx_tuple__26);
  __pyx_codeobj__27 = (PyObject*)__Pyx_PyCode_New(4, 0, 12, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__26, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_smlm_analysis_cluster__focal_inn, __pyx_n_s_density_map, 25, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__27)) __PYX_ERR(0, 25, __pyx_L1_error)
 ...
 *     cdef:
 */
  __pyx_tuple__28 = PyTuple_Pack(12, __pyx_n_s_i_x, __pyx_n_s_i_y, __pyx_n_s_grid, __pyx_n_s_minL, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_m, __pyx_n_s_n, __pyx_n_s_xsize, __pyx_n_s_ysize, __pyx_n_s_density, __pyx_n_s_core_map); if (unlikely(!__pyx_tuple__28)) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__28);
  __Pyx_GIVEREF(__pyx_tuple__28);
  __pyx_codeobj__29 = (PyObject*)__Pyx_PyCode_New(4, 0, 12, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__28, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_smlm_analysis_cluster__focal_inn, __pyx_n_s_density_map_at_minl, 45, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__29)) __PYX_ERR(0, 45, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC init_focal_inner(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC init_focal_inner(void)
#else
__Pyx_PyMODINIT_FUNC PyInit__focal_inner(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit__focal_inner(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec__focal_inner(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module '_focal_inner' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit__focal_inner(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("_focal_inner", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_smlm_analysis__cluster___focal_inner) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "smlm_analysis.cluster._focal_inner")) {
      if (unlikely(PyDict_SetItemString(modules, "smlm_analysis.cluster._focal_inner", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "smlm_analysis/cluster/_focal_inner.pyx":3
 * cimport cython
 * cimport numpy as np
 * import numpy as np             # <<<<<<<<<<<<<<
 * 
 ...
 *     cdef:
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_13smlm_analysis_7cluster_12_focal_inner_1density_map, NULL, __pyx_n_s_smlm_analysis_cluster__focal_inn_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 25, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_density_map, __pyx_t_1) < 0) __PYX_ERR(0, 25, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *     cdef:
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_13smlm_analysis_7cluster_12_focal_inner_3density_map_at_minl, NULL, __pyx_n_s_smlm_analysis_cluster__focal_inn_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_density_map_at_minl, __pyx_t_1) < 0) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "smlm_analysis/cluster/_focal_inner.pyx":1
 * cimport cython             # <<<<<<<<<<<<<<
 * cimport numpy as np
 * import numpy as np
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init smlm_analysis.cluster._focal_inner", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init smlm_analysis.cluster._focal_inner");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
